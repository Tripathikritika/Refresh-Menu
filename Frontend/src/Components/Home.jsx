  ...
  return (
    ...
    <div className={classes.root}>
      <div onClick={handleDrawerOpen}  className = {clsx(open && classes.hide)}>
          <img src="./carticon.svg" alt="carticon.svg" style={{position:"absolute" ,top:'12%' , right: open ? '11.5%' : '11.5%'}} />
      </div>
      ...
      { 
      open &&
        <img src="./carticon.svg" alt="carticon.svg" style={{position:"absolute" ,top:'12%' , right:'23.5%'}} />
      }
